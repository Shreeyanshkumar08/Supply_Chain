...
export default function CreatePage() {
  ...
  const { createSupply } = usePollMutations();
  ...
  return (
    <div className="w-full my-8 px-4">
      <h1 className="text-[48px] text-center font-bold">Create Your Supply</h1>
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="w-full md:w-1/2 mx-auto my-8">
          ...
          <div className="my-8">
            <h3 className="text-xl font-semibold my-4">Supply Title</h3>
            <input
              type="text"
          ...
          <div className="my-8">
            ...
            <textarea
              ...
              placeholder="Mention details and resources required for the Supply"
              name="description"
